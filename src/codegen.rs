...
struct Compiler<'src, 'project> {
    ...
    variables: HashMap<Id<mir::Variable>, sb3::VariableRef<'src>>,
    lists: HashMap<Id<mir::List>, sb3::ListRef<'src>>,
    returns: &'project HashMap<Id<mir::BasicBlock>, Vec<sb3::VariableRef<'src>>>,
    custom_blocks: &'project HashMap<Id<mir::BasicBlock>, sb3::CustomBlockRef>,
    points: HashMap<Id<mir::BasicBlock>, sb3::InsertionPoint<'src>>,
